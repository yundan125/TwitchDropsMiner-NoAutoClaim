...
> This repository contains an unofficial `16.dev` source build patched with an
> automatic Drop-claim toggle. See [PATCHED_BUILD.md](PATCHED_BUILD.md) for the
> patch behavior, privacy notes, binary download, and SHA-256 verification.
