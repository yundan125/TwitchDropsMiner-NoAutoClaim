...
class StatusMessages(TypedDict):
    ...
    no_channel: str
    no_campaign: str
    # TDM_CLAIM_TOGGLE_PATCH_BEGIN: status-translations-schema
    pending_claim: str
    trying_another_drop: str
    prerequisite_warning: str
    # TDM_CLAIM_TOGGLE_PATCH_END: status-translations-schema
...
class GUISettingsGeneral(TypedDict):
    ...
    priority_mode: str
    proxy: str
    # TDM_CLAIM_TOGGLE_PATCH_BEGIN: settings-translations-schema
    auto_claim_drops: str
    auto_claim_drops_help: str
    # TDM_CLAIM_TOGGLE_PATCH_END: settings-translations-schema
...
default_translation: Translation = {
    ...
    "status": {
        ...
        # TDM_CLAIM_TOGGLE_PATCH_BEGIN: status-translations
        "pending_claim": "Auto-claim is disabled. Drop completed and left unclaimed: {drop}",
        "trying_another_drop": "Trying to continue with another available Drop.",
        "prerequisite_warning": (
            "The next Drop may require claiming its prerequisite on Twitch: {drop}"
        ),
        # TDM_CLAIM_TOGGLE_PATCH_END: status-translations
    },
    "login": {
        "unexpected_content": (
    ...
    "gui": {
        ...
        "settings": {
            "general": {
                ...
                # TDM_CLAIM_TOGGLE_PATCH_BEGIN: settings-translations
                "auto_claim_drops": "Automatically claim Drops",
                "auto_claim_drops_help": (
                    "When disabled, completed Drops are left unclaimed and the miner "
                    "attempts to continue with other available Drops. Twitch may require "
                    "prerequisite Drops to be claimed in some campaigns."
                ),
                # TDM_CLAIM_TOGGLE_PATCH_END: settings-translations
            },
            "advanced": {
                "name": "Advanced",
                "warning": "Warning!",
